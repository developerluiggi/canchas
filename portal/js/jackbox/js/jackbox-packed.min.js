(function(c){
    ...
    if("null"!==d.tracker&&d.tracker!==F){
        var a=c.isFunction(d.tracker)?d.tracker:f[d.tracker],b=(k.pathname+k.search+(c.address&&!B()?c.address.value():"")).replace(/\/\//,"/").replace(/^\/$/,"");
...
(function(){
    function z(){
        ...
        var d={},n;
        b=b.to;
        for(n in b)b.hasOwnProperty(n)&&(d[n]=b[n]);Jacked.tween(a,d,c)
        }
        function ha(a,b){
...
if(!O||!H)O=H=null;
    ...
    for(var b=this.length;b--;)if(this[b]===a)return b;return-1
    });
...
this.Jacked={
    ...
    setEngines:function(a){
        for(var b in a)I.hasOwnProperty(b)&&(I[b]=a[b]);ja()
        },
...
this.CJ=function(a,b,c){
    ...
    this.runner=function(n){
        ...
        if(!0===n)d.transitions=[];
            ...
            var m;
            n=0;
            var g=[],e=a.style,p=c.duration||K,r=(c.ease||J).toLowerCase().split("."),r=M[r[0]][r[1]];
            ...
            for(m in b)b.hasOwnProperty(m)&&("backgroundPosition"!==m?g[n++]=d.animate(a,m,b[m],p,r):g[n++]=d.bgPosition(a,m,b[m],p,r));d.transitions=g;
            u?setTimeout(Y,10):z()
            }
        };
            ...
            for(p in b)if(b.hasOwnProperty(p)){
                ...
                if(!T.test(k)&&"opacity"!==p&&!j&&!m)k+="px;";
                    ...
                    if(!j&&!u)k+="px",e+="px";
                        ...
                        var v=n.backgroundPosition,v=""!==v?v.split(" "):R(a,null).backgroundPosition.split(" ");
                        !j?k+="px":k=v[0];
                        !u?e+="px":e=v[1]
                        }
                        k=k+" "+e+";"
...
this.CJpercentage=function(a,b,c){
    ...
    this.runner=function(){
        ...
        for(g in k)k.hasOwnProperty(g)&&(p=parseInt(h[g],10),e=parseInt(k[g],10),m[n++]=[p>e,g,p,e]);a.style.visibility="visible";
...
(function(){
    ...
    window.StackBlurImage=function(m,E,r){
        ...
        if(!(isNaN(r)||1>r))if(!(isNaN(r)||1>r)){
            ...
            for(a=1;a<s;a++)if(b=b.next=new I,a==l)var J=b;b.next=D;
            for(x=F=e=0;x<w;x++){
                i=j=k=f=g=h=0;
                t=l*(n=c[e]);
                u=l*(p=c[e+1]);
        ...
        if(e){
            ...
            if(-1<g){
                ...
                for(m=e.length;m--;)if(l=e[m],l[0]===d[0]){
                    if(b)if(e.splice(m,1),l.off("click.jackbox"),d=e.length)for(g= 0;g<d;g++)e[g].data("id",g);else K.splice(g,1),L.splice(g,1),Ra--;
                    return
                }
                m=e.length;
                e[m]=d
...
function dc(a){
    ...
    if(p=e.attr("href")||e.attr("data-href")){
        ...
        b=p;
        if(b=-1!==b.search("youtube.com")?"youtube":-1!==b.search("vimeo.com")?"vimeo":"mp4"===a?"local":!1)e.data("type",b),e.attr("data-thumbnail")||("vimeo"===b?Xc(e,p):"youtube"===b&&e.attr("data-thumbnail","http://img.youtube.com/vi/"+p.split("http://www.youtube.com/watch?v=")[1]+"/1.jpg"));
        else if("jpg"===a||"png"===a||"jpeg"===a||"gif"===a)e.data("type", "image");else switch(a){
            case "mp3":
                e.data("type","audio");
                break;
            case "swf":
...
function ab(){
    ...
    function lc(){
    for(var a=[v[0],ia[0],w[0],ka[0]],b=4;b--;)a[b].removeEventListener("touchstart",D,!1),a[b].removeEventListener("touchmove",D,!1),a[b].removeEventListener("touchend",D,!1)
        }
        function jc(){
    eb=K[H];
    if(e=eb[f]){
        if(s)for(var a=[v[0],ia[0],w[0],ka[0]],b=4;b--;)a[b].addEventListener("touchstart",D,!1),a[b].addEventListener("touchmove", D,!1),a[b].addEventListener("touchend",D,!1);
...
function Zc(){
    ...
    switch(O){
        ...
        case "vimeo":
            ...
            break;
        case "local":
            var b=Hb(),d="true"===e.attr("data-firefoxUsesFlash")?"true":"false",g=e.attr("data-flashHasPriority")?e.attr("data-flashHasPriority"):yc.toString();
...
function $c(a){
    ...
    if(M){
        ...
        for(ba.off(".jackbox").hide();x.length;)a=x[0],Jacked.stopTween(a[0]),a.remove(),x.shift();
        ca.off(".jackbox").hide();
        da.off(".jackbox").hide();
...
function Xc(a,b){
    ...
    function qd(){
    var a=c(this),b=a.data("parent"),d=parseInt(b.css("width"),10)||b.width(),m=parseInt(b.css("height"),10)||b.height(),b=c("<canvas />").addClass("jackbox-canvas-blur").attr({
        width:d,
        height:m
    }).insertBefore(b), m=Date.now(),d=m+1,m=m+2;
    a.attr("id",d);
    b.attr("id",m);
...
//}, $=10,Ea=2,Rb="/php/graphics.php",Kb="/modules/jackbox_swf.html",Sb="/img/thumbs/default.jpg",Ib="/modules/jackbox_video.html",Jb="/modules/jackbox_audio.html",Tb="/modules/jackbox_social.php",dd="http://player.vimeo.com/video{url}?title=0&byline=0&portrait=0&autoplay={autoplay}&color=FFFFFF&wmode=transparent",cd="http://www.youtube.com/embed/{url}?autoplay={autoplay}&autohide=1&hd=1&iv_load_policy=3&showinfo=0&showsearch=0&wmode=transparent",vb='<div class="jackbox-top clearfix"><div class="jackbox-social"></div><div class="jackbox-top-icons"><span class="jackbox-fullscreen"><span class="jackbox-button jackbox-fs"></span><span class="jackbox-button jackbox-ns"></span></span><span class="jackbox-button jackbox-button-margin jackbox-close"></span></div><div />', wb='<div class="jackbox-bottom clearfix"><div class="jackbox-controls"><span class="jackbox-button jackbox-arrow-left"></span><span class="jackbox-button jackbox-arrow-right"></span></div><div class="jackbox-title-text"><span class="jb-current"></span><span class="jb-divider">/</span><span class="jb-total"></span><span class="jackbox-title-txt"></span></div><div class="jackbox-bottom-icons"><span class="jackbox-button jackbox-info"></span><span class="jackbox-button-margin jackbox-button-thumbs"><span class="jackbox-button jackbox-hide-thumbs"></span><span class="jackbox-button jackbox-show-thumbs"></span></span></div></div>', kc,C,wa,rc,sc,Ub,Eb,rb,xb,Wa,Vb,Hc,Ja,fb,Ic,F,Db,Wb,V,u,Xb,da,B,P,fa,Y,ea,ta,S,Oa,ja,pa,ca,ka,Z,ra,va,Yb,Gb,Bb,fc,sa,Ma,La,oa,A,Aa,lb,za,Jc,Xa,Kc,Ba,Na,y,ia,Ca,ya,X,hb,xa,kb,Lc,s,gb,sb,Ya,v,E,e,Pa,z,Ha,r,p,q,J,R,Mc,L,n,ma,K,ua,Da,Zb,tc,Qa,x,ac,w,yb,T,tb,Sa,Nc,h,U,Va,I,N,ob,Ob,O,oc,ib,ga,Q,aa,pc,$a,Ga,Ua,jb,Ta,la,M,ld,Pb,eb,Ia,W,Za,pb,ba,qb,qc,kd,Oc,Fa,$b,Qb,wc,ha,bc,G,yc,Pc,Qc,Fb,Ec,Fc,f=1,H=-1,Ra=0,ic=!0,gc=!0,Rc={
    ...
    return function(c){
        if(c){
            ...
            }else c=q,d.width=c,a.duration=300,delete a.callback,B&&Jacked.tween(B[0],d,a),C&&Jacked.tween(C[0],d,a),d.height=n,Jacked.stopTween(h[0],!0),Jacked.tween(h[0],d,a);
    ...
    return function(){
        ...
        if(!Qb&&jb&&X){
            ...
            for(Qb=!0;g--;)k=d[g],k.attr("data-thumbnail")?e[g]=!1:(f=k.children("img"),f.length?(k.attr("data-thumbnail",f.attr("src")),e[g]=f):("image"===k.data("type")? k.attr("data-thumbnail",k.attr("href")||k.attr("data-href")):k.attr("data-thumbnail",Sb),e[g]=!1));
            x=[];
    ...
    return function(){
        s&& (clearTimeout(Lc),Lc=setTimeout(zc,2E3));
        var b=c(this),d,e,g;
    ...
    return function(d,c){
        if(d)y=f,0!==f&&f+ra>R&&(y=R-ra),Jacked.stopTween(V[0]),V.css("left",y*-ga);
        else{
            if(0===f)y=0;
    ...
    return function(d,c){
        ca.off(".jackbox");
        da.off(".jackbox");
        if($b)if(s&&u.cjSwipe("unbindSwipe"),y<R-ra?(da.on("click.jackbox",Ac).show(),s&&u.cjSwipe("touchSwipeLeft",Ac,!0)):da.hide(),0<y?(ca.on("click.jackbox",Bc).show(),s&&u.cjSwipe("touchSwipeRight",Bc,!0)):ca.hide(),c)a.left=y*-ga,Jacked.tween(V[0],a,b);
            else{
            if(d||!Pb){
                var e=u.offset().left;
                ca.css("left",e);
