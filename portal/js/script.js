$(document).ready(function(){
    ...
    function enableNewsletterForm(){
        ...
        $('#newsletter').submit(function(e){
            ...
            if(email_val == '' || email_val == ' '){
                ...
                error = true;
                form.find('.newsletter-email input').tooltip({
                    title:'Required', 
                    trigger: 'manual'
                });
            ...
            if(zip_val == '' || zip_val == ' '){
                ...
                error = true;
                form.find('.newsletter-zip input').tooltip({
                    title:'Required', 
                    trigger: 'manual'
                });
    ...
    function enableProductSlider(){
        ...
        $('.shop-product-gallery .slider-navigation li').click(function(e){
            ...
            $('.shop-product-gallery .main-image img').animate({
                opacity:0
            },300,function(){
